...
const Navbar = () => {
    const navLinks =
        <>
            ...
            <Link to="/"><li className="w-full btn btn-sm border-1 bg-black  text-cyan-200 hover:border-2 hover:border-cyan-500 overflow-hidden transition-all hover:scale-105  hover:shadow-2xl my-1">Contact</li></Link>
        </>
    return (
        <div>
            <div className="navbar fixed z-10 bg-black bg-opacity-80 max-w-screen-xl mx-auto">
                <div className="navbar-start px-1">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-black bg-opacity-30 rounded-box w-52 text-cyan-200">
                            {
                                navLinks
                            }
                        </ul>
