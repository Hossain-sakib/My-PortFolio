            ...
            <div className="navbar fixed z-10 bg-black bg-opacity-80 max-w-screen-xl mx-auto">
                <div className="navbar-start px-1">
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn btn-sm btn-ghost lg:hidden  bg-black border-1 border-cyan-500 text-cyan-200 hover:border-1 hover:border-cyan-500 overflow-hidden transition-all hover:scale-105  hover:shadow-2xl">
