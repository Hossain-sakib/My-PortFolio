...
const Contact = () => {
    return (
        <div>
            <div className="flex items-center flex-col md:flex-row gap-4 mt-8 py-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <div>
                            ...
                            <div className="flex items-center gap-4">
                                <button className="btn btn-circle border-1 bg-black border-cyan-500 text-cyan-200 hover:border-1 hover:border-cyan-500 overflow-hidden transition-all hover:scale-105  hover:shadow-2xl text-2xl"><FaAddressCard></FaAddressCard></button>
                                <p className="text-xl text-cyan-100">BSCIC Road,Kanchpur,<br />Narayanganj,Bangladesh</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                            <button className="btn btn-circle border-1 bg-black border-cyan-500 text-cyan-200 hover:border-1 hover:border-cyan-500 overflow-hidden transition-all hover:scale-105  hover:shadow-2xl text-2xl"><IoMdCall></IoMdCall></button>
                            <p className="text-xl text-cyan-100">+8801576636011</p>
                        </div>
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-xl text-cyan-100">+8801955703819</p>
                        </div>
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-xl text-cyan-100">Hossain.Sakib.X@gmail.com</p>
                        </div>
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-xl text-cyan-100">Hossain-Sakib-X</p>
                        </div>
                        <div className="flex items-center gap-4">
